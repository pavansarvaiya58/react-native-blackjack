		...
		return (
			<View style={styles.centerView}>
				...
				<View style={styles.center}>
					...
					<CardDeck cards={playerHand} totalBet={totalBet} />
				</View>

				{/* {totalBet == false && (
					<View style={styles.absoluteBtnRight}>
						<ActionButton
							direction={"left"}
							text={"NEW CARDS"}
							onPress={() => newGame()}
				...
				{totalBet == false && (
					<View style={[styles.absoluteBtnRight, { top: 60 }]}>
						<ActionButton
							direction={"left"}
							text={"5K PLEASE"}
							onPress={() => moreMoney()}
				...
				{!!totalBet && (
					<View style={[styles.absoluteBtnRight, { top: 105 }]}>
						<ActionButton
							direction={"left"}
							text={"DOUBLE"}
							onPress={() => doubleGame()}
				...
				{!!totalBet && (
					<View style={[styles.absoluteBtnRight, { top: 150 }]}>
						<ActionButton
							direction={"left"}
							text={"DEAL"}
							onPress={() => endgame()}
